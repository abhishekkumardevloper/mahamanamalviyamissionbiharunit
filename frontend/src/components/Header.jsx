    ...
    >
      <div className="container mx-auto px-4 lg:px-6 xl:px-8">
        <div className="flex items-center justify-between gap-2 xl:gap-4">
          ...
          {/* --- CENTER: Desktop Navigation (Fixed for xl only to prevent overlap) --- */}
          ...
          <div className="flex items-center gap-3 lg:gap-4 xl:gap-5 z-50 shrink-0">
            ...
            {/* Join Us Button (Fixed to xl only) */}
            <Link
              to="/join"
              className="hidden xl:flex items-center gap-2 bg-gradient-to-r from-[#F4C430] to-[#ffd700] text-[#111111] px-5 xl:px-6 py-2.5 rounded-full font-extrabold text-sm hover:shadow-[0_0_20px_rgba(244,196,48,0.4)] transform hover:-translate-y-0.5 transition-all duration-300 whitespace-nowrap"
              style={getFont()}
            >
              {t('nav.join')}
            ...
            {/* Mobile/Tablet Hamburger Toggle (Now shows on lg too) */}
            <button
              className="xl:hidden text-[#F4C430] p-2 hover:bg-white/10 rounded-full transition-colors shrink-0"
      ...
      {/* --- MOBILE/TABLET NAVIGATION OVERLAY (Fixed mobile overflow issue) --- */}
      <div 
        className={`xl:hidden fixed inset-0 top-[72px] bg-[#111111]/95 backdrop-blur-xl border-t border-white/10 transition-all duration-300 ease-in-out origin-top ${
      ...
      >
        <div className="flex flex-col h-full p-6 overflow-y-auto">
          ...
          <div className="mt-8 pt-8 border-t border-white/10 max-w-lg mx-auto w-full">
            <Link
              to="/join"
